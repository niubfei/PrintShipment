...
{
    public class Code128 : IFBarcode
    {
        public enum TYPES:int { DYNAMIC, A, B, C };
        protected DataTable C128_Code = new DataTable("C128");
        protected List<string> _FormattedData = new List<string>();
        protected List<string> _EncodedData = new List<string>();
        protected DataRow StartCharacter = null;
        protected TYPES type = TYPES.DYNAMIC;
        ...
        protected void InitBarCode()
        {
            ...
            _EncodedData.Clear();
            C128_Code.Clear();
            C128_Code.Rows.Clear();
            C128_Code.Columns.Clear();
        ...
        protected List<DataRow> FindStartorCodeCharacter(string s, ref int col)
        {
        ...
        protected string CalculateCheckDigit()
        {
        ...
        protected void BreakUpDataForEncoding(string code)
        {
            string temp = "";
            string tempRawData = code;

            //CODE C: adds a 0 to the front of the Raw_Data if the length is not divisible by 2
            if (this.type == TYPES.C && code.Length % 2 > 0)
                tempRawData = "0" + code;
        ...
        protected void InsertStartandCodeCharacters()
        {
        ...
        protected string GetEncoding(string strCode)
        {
            //break up data for encoding
            BreakUpDataForEncoding(strCode);
        ...
        {
            return CreateBarcodeImage(text);
        }
    }//class
}//namespace
