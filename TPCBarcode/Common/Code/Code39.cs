...
namespace TPCBarcode.Common.Code
{
    public class Code39 : IFBarcode
    {
        ...
        public override string Encode(string text)
        {
            ...
            string strFormattedData = "*" + text.Replace("*", "") + "*";

            if (_AllowExtended)
                InsertExtendedCharsIfNeeded(ref strFormattedData, text);
        ...
        private void InsertExtendedCharsIfNeeded(ref string FormattedData, string code)
        {
            string output = "";
